...
#functions
proposeNewOwner(address payable _newOwner) : callers: guardians
...
setAllowance(address _for, uint256 _amount): callers: owner
...
setGuardian(address _guardian, bool _isguardian): callers: owner
                                                  condition: caller should be the owner.
